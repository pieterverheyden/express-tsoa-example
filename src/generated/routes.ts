    ...
    // ###########################################################################################################
        app.get('/users/:email',
            ...
            try {
              ...
              const promise = controller.getUserByEmail.apply(controller, validatedArgs as any);
        ...
        app.put('/users',
            ...
            function UsersController_createOrUpdateUser(request: any, response: any, next: any) {
            const args = {
            ...
            try {
              ...
              const promise = controller.createOrUpdateUser.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
